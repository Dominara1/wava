...
if(PIPEWIRE)
    ...
    if(PIPEWIRE_FOUND)
        ...
        add_library(in_pipewire SHARED "${WAVA_MODULE_DIR}/main.c"
                                    "${GLOBAL_FUNCTION_SOURCES}")
        target_link_libraries(in_pipewire wava-shared "${PIPEWIRE_LIBRARIES}")
        ...
        install(TARGETS in_pipewire DESTINATION lib/wava)
