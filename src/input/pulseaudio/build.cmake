...
if(PULSEAUDIO)
    ...
    if(PULSEAUDIO_FOUND)
        ...
        add_library(in_pulseaudio SHARED "${WAVA_MODULE_DIR}/main.c"
                                        "${GLOBAL_FUNCTION_SOURCES}")
        target_link_libraries(in_pulseaudio wava-shared "${PULSEAUDIO_LIBRARIES}")
        ...
        install(TARGETS in_pulseaudio DESTINATION lib/wava)
