...
if(CAIRO_MODULES)
    ...
    if(CAIRO_FOUND)
        add_library(cairo_stars SHARED "${WAVA_MODULE_DIR}/main.c"
        ...
        target_include_directories(cairo_stars PRIVATE
            "${CAIRO_INCLUDE_DIRS}")
        target_link_libraries(cairo_stars wava-shared "${CAIRO_LIBRARIES}")
        ...
        configure_file("${WAVA_MODULE_DIR}/config.ini" cairo/module/stars/config.ini COPYONLY)
        ...
        install(FILES "${CMAKE_BINARY_DIR}/cairo/module/stars/config.ini" RENAME config.ini.example DESTINATION share/wava/cairo/module/stars/)
        install(TARGETS cairo_stars RENAME module DESTINATION share/wava/cairo/module/stars/)
    else()
