...
if(CAIRO_MODULES)
    ...
    if(CAIRO_FOUND)
        add_library(cairo_bars SHARED "${WAVA_MODULE_DIR}/main.c"
        ...
        target_include_directories(cairo_bars PRIVATE
            "${CAIRO_INCLUDE_DIRS}")
        target_link_libraries(cairo_bars wava-shared "${CAIRO_LIBRARIES}")
        ...
        configure_file("${WAVA_MODULE_DIR}/config.ini"   cairo/module/bars/config.ini   COPYONLY)
        ...
        install(FILES "${CMAKE_BINARY_DIR}/cairo/module/bars/config.ini" RENAME config.ini.example DESTINATION share/wava/cairo/module/bars/)
        install(TARGETS cairo_bars RENAME module DESTINATION share/wava/cairo/module/bars/)
    else()
