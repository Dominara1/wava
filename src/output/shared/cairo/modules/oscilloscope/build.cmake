...
if(CAIRO_MODULES)
    ...
    if(CAIRO_FOUND)
        add_library(cairo_oscilloscope SHARED "${WAVA_MODULE_DIR}/main.c"
                                    "${WAVA_MODULE_DIR}/../shared/config.c"
        ...
        target_include_directories(cairo_oscilloscope PRIVATE
            "${CAIRO_INCLUDE_DIRS}")
        target_link_libraries(cairo_oscilloscope wava-shared "${CAIRO_LIBRARIES}")
        ...
        configure_file("${WAVA_MODULE_DIR}/config.ini"   cairo/module/oscilloscope/config.ini   COPYONLY)
        ...
        install(FILES "${CMAKE_BINARY_DIR}/cairo/module/oscilloscope/config.ini" RENAME config.ini.example DESTINATION share/wava/cairo/module/oscilloscope/)
        install(TARGETS cairo_oscilloscope RENAME module DESTINATION share/wava/cairo/module/oscilloscope/)
    else()
