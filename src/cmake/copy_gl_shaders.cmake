...
foreach(files ${filters})
    ...
    string(REPLACE "${wava_SOURCE_DIR}/example_files/" "" target_path ${path})
    ...
    install(FILES "example_files/${target_path}/vertex.glsl" RENAME vertex.glsl.example DESTINATION "share/wava/${target_path}")
endforeach()
...
foreach(files ${filters})
    ...
    install(FILES "example_files/${target_path}/geometry.glsl" RENAME geometry.glsl.example DESTINATION "share/wava/${target_path}")
endforeach()
...
foreach(files ${filters})
    ...
    install(FILES "example_files/${target_path}/fragment.glsl" RENAME fragment.glsl.example DESTINATION "share/wava/${target_path}")
endforeach()
...
foreach(files ${filters})
    ...
    install(FILES "example_files/${target_path}/config.ini" RENAME config.ini.example DESTINATION "share/wava/${target_path}")
endforeach()
